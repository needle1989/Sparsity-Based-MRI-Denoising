function est_theta_DP_S_1=DPSeperatedSearch_MPSK(Xdp_hat,alpha_DP,theta_ex,alpha0_DP,pos_channel,Y_temp,A_temp);
i=sqrt(-1);
T=256;
M=10;
C=1500;
...
figure
plot(theta_test,10*log(abs(temp_func_inv)/max((abs(temp_func_inv)))),'r-');
